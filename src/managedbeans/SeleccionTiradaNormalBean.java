...
@ManagedBean
@SessionScoped
public class SeleccionTiradaNormalBean implements Serializable {
	...
	public SeleccionTiradaNormalBean() {
	}
	...
	public void onCarDrop(DragDropEvent ddEvent) {
		...
		if (cartasSeleccionadas.isEmpty() == true || cartasSeleccionadas.size() <= 9) {
	...
	public String verTirada() {

		if (contador == 10) {
			System.out.println(contador+ "if");
			return "resultadoTiradaNormal.xhtml?faces-redirect=true";
		} else {
			
			System.out.println(contador + "else");
			return null;
		}
	}
